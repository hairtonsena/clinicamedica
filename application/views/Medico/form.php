...
<div class="col-lg-6">
    <div class="col-lg-6">
        <div class="form-group">
            <label>CRM</label>
            <input name="crm" type="text" value="<?php echo $form['crm']?>" class="form-control">
            <?php echo form_error('crm','<span class="text-danger">','</span>'); ?>
        </div>
    ...
    <div class="col-lg-6">
        <div class="form-group">
            ...
            <input name="especializacao" type="text" value="<?php echo $form['especializacao']?>" class="form-control">
            <?php echo form_error('especializacao','<span class="text-danger">','</span>'); ?>
        </div>

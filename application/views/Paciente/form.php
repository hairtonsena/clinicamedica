...
<div class="col-lg-12">
    <div class="col-lg-6">
        <div class="form-group">
            <label>Fixa</label>
            <textarea name="fixa" class="form-control"><?php echo $form['fixa']?></textarea>
            <!--<input name="codigo" type="text" value="" class="form-control">-->
            <?php echo form_error('fixa','<span class="text-danger">','</span>'); ?>
        </div>
        ...
        <div class="form-group">
            <label>
                <input name="status" type="checkbox" value="1" <?php if($form['status']==1){ echo 'checked'; } ?> class=""> Status</label>
...
<div class="col-lg-12">
    <div class="form-group text-right">
        <a href="<?php echo base_url('paciente') ?>" class="btn btn-default">Cancelar</a>
